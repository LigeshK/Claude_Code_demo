  ...
  return (
    <>
      ...
      <dialog
        ...
        style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)", margin: 0, width: "320px" }}
      >
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px" }}>
          <button
            ...
            style={{ padding: "8px 16px", borderRadius: "8px", fontSize: "14px", fontWeight: 500, cursor: "pointer", background: "#f3f4f6", border: "none", color: "#374151" }}
          >
            Cancel
          </button>
          <button
            ...
            disabled={isPending}
            style={{ padding: "8px 16px", borderRadius: "8px", fontSize: "14px", fontWeight: 500, cursor: "pointer", background: "#dc2626", border: "none", color: "#fff", opacity: isPending ? 0.5 : 1 }}
          >
